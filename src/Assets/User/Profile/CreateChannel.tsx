...
import useCreateChannel from '@/Hooks/User/Profile/useCreateChannel'
...
export default function CreateChannel({ open, setOpen }: CreateChannelProps) {
    const {
        state,
        setState,
        inputRef,
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogContent style={{scrollbarWidth:"none"}} className="max-w-lg bg-blue-light max-h-[90%] overflow-y-scroll dark:text-white dark:bg-background text-foreground dark:text-foreground-dark">
                ...
                <DialogHeader>
                    <DialogTitle className="text-center dark:text-white">Create Channel</DialogTitle>
                </DialogHeader>
                    ...
                    <div className="flex items-center justify-center">
                        <div className="relative">
                            <img
                                ...
                                src={state.Logo ? URL.createObjectURL(state.Logo) : 'https://images.pexels.com/photos/3377405/pexels-photo-3377405.jpeg?cs=srgb&dl=pexels-elina-araja-1743227-3377405.jpg&fm=jpg'}
                                alt="Channel logo"
                            />
                            <Button
                                variant="secondary"
