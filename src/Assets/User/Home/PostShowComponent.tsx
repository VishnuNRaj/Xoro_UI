  ...
  return (
    <div className="animate-slideInFromLeft p-4">
      ...
      <div
        ...
        className="bg-blue-light dark:bg-background border border-border rounded-lg flex-shrink-0 lg:min-w-[420px] lg:max-w-2xl"
      >
        <div className="flex items-center px-4 py-3 relative">
          ...
          />
          <div className="ml-3">
            <span className="text-sm font-semibold antialiased block leading-tight text-black dark:text-white">
              {post.user?.Name}
            </span>
            <span className="text-muted-foreground text-xs block dark:text-gray-300">
              {post.user?.Username}
            </span>
          </div>
                  ...
                  {postData.tags.length > 0 && (
                    <div className="absolute bottom-3 right-3">
                      <Button
                        variant="secondary"
                        size="sm"
                        className="bg-white/70 hover:bg-white/70 text-black"
                      >
        ...
        <div className="flex items-center justify-between mx-4 mt-3 mb-2">
          <div className="flex gap-5">
            ...
            >
              <ThumbsUp
                className={`h-5 w-5 ${
                  like ? "text-blue-500" : "text-black dark:text-white"
                }`}
              />
            </Button>
            <Button
            ...
            >
              <ThumbsDown
                className={`h-5 w-5 ${
                  dislike ? "text-red-500" : "text-black dark:text-white"
                }`}
              />
            </Button>
            <Button
        ...
        {postData.Caption.length > 0 && (
          <div
            ...
            } font-semibold mx-4 flex items-center flex-shrink-0 text-sm text-black dark:text-white`}
          >
          ...
          <div className="font-semibold text-sm mx-4 items-center mb-4">
            ...
            <div className="font-light text-xs text-gray-600 dark:text-gray-300 flex items-center">
              <h1 className="mr-1">
                liked by{" "}
                {like &&
                  `you ${post.reactions.LikesDetails.length > 1 ? "&" : ""}`}
              </h1>
