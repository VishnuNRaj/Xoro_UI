        ...
        {stream ? (
          <video
            ...
            className={`${
              width < 968
                ? "w-full h-full"
                : "aspect-video object-cover w-[60%]"
            } mt-2 rounded-md shadow-md shadow-gray-700 dark:shadow-gray-500 md:border-0 border-2`}
          />
        ) : (
          <div className="flex items-center justify-center gap-4">
            <Button onClick={startCamera} className="w-32 text-white">
              <Camera className="mr-2 h-4 w-4" /> Camera
            </Button>
            <Button onClick={startScreenShare} className="w-32 text-white">
