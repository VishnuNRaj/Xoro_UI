...
import { Lock, Image, Plus, MessageCircle, UserPlus } from "lucide-react"
...
export default function ProfileComponent() {
    const { user, userData, loading, loadingProfile, post, type, setType, Connection, FollowUser, UnfollowUser } = useUserProfiles()
                        ...
                        <div className="mt-4 sm:mt-0 flex gap-2 text-white">
                            {userData && user && userData?._id !== user?._id && (
                                <>
                                    ...
                                    <Button onClick={Connection.Follower ? UnfollowUser : FollowUser} size="sm">
                    ...
                    <div className="w-full flex justify-center items-center text-center border-border dark:border-border-dark pt-4">
                        <div className="flex items-center max-w-xl justify-between w-full mt-6 pt-4 border-t text-center">
                            <Button variant="ghost" className="hover:bg-transparent">
                                <div>
                                    <p className="text-xl font-bold">{post?.Images.length || "0"}</p>
